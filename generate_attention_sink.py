...
def _load_model(checkpoint_path, device, precision, use_tp, sliding_window, global_tokens):
...
def main(
    ...
    print("Loading model ...")
    t0 = time.time()
    model = _load_model(checkpoint_path, device, precision, use_tp, sliding_window, global_tokens)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--global_tokens', type=int, default=2, help='Global tokens.')
    ...
    main(
        ...
        args.speculate_k, args.device, args.sliding_window, args.global_tokens
    )
