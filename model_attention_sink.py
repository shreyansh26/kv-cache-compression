...
class Transformer(nn.Module):
    def __init__(self, config: ModelArgs, sliding_window: Optional[int] = None, global_tokens: Optional[int] = None) -> None:
        super().__init__()
        self.config = config
    ...
    def setup_caches(self, max_batch_size, max_seq_length):
        ...
        for b in self.layers:
            b.attention.kv_cache = KVCacheAttentionSink(max_batch_size, max_seq_length, self.config.n_local_heads, head_dim, dtype, self.global_tokens, self.sliding_window)
